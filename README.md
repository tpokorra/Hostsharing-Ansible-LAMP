Hostsharing-Ansible-LAMP
========================

This Ansible playbook will prepare a LAMP (Linux Apache Mysql PHP) environment on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-LAMP.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-LAMP
